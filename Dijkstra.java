...
public class Dijkstra {
  ...
  public void init() {
    ...
    long elapsed = end - start;
    elapsed = (long) (elapsed / Math.pow(10, 6));
    log("m\t" + "initialisation complete in " + elapsed + " miliseconds.");
  ...
  public LinkedList<Vertex> computeShortestPath() {
    ...
    if (s == null) {
      ...
      log("m\t" + "source is invalid -->> terminating.");
      return null;
    ...
    if (t == null) {
      ...
      log("m\t" + "destination is invalid -->> terminating.");
      return null;
    ...
    while(!Q.isEmpty()) {
      ...
      if (focus.isEqual(t)) {
        ...
        log("m\t" + "-----------------------");
        log("m\t" + "Dijkstra's algorithm is terminated with success.");
        log("m\t" + shortestPath.toString());
      ...
      for (Edge e: focus.adjList()) {
        ...
        log("c\t" + w + "\t" +"inf" + "\t" + w.getPath().toString());
    ...
    log("m\t" + "there is no " + s + " - " + t + " path in the graph.");
    return null;
